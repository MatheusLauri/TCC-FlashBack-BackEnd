...
export async function ListIngresso(id, evento ){
    ...
    SELECT 	INGRESSO.ID_INGRESSO,
        ...
        GROUP BY
        INGRESSO.ID_INGRESSO, DATAS.ID_DATA_INGRESSO, NM_CATEGORIA_INGRESSO, NM_EVENTO, DS_HORARIO, DS_LOGRADOURO, DS_LOCALIDADE, DS_UF, DS_NUM, DS_EVENTO, IMAGEM_INGRESSO, BT_DESTAQUE
