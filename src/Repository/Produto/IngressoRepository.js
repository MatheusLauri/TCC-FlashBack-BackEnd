...
export async function BuscarNomeIngresso(nome){
    ...
    const comando = 
        ...
        GROUP BY
        NM_CATEGORIA_INGRESSO, NM_TIPO_INGRESSO, QTD_TIPO_INGRESSO, VL_PRECO_TIPO, NM_EVENTO, DS_HORARIO, DS_LOGRADOURO, DS_LOCALIDADE, DS_UF, DS_NUM, DS_EVENTO, IMAGEM_INGRESSO, DT_CADASTRO, BT_DESTAQUE
