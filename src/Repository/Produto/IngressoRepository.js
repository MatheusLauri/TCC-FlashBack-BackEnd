...
export async function ListarIngressosDestaque(){
    ...
    SELECT  	INGRESSO.ID_INGRESSO,
        ...
        GROUP BY
        INGRESSO.ID_INGRESSO, NM_CATEGORIA_INGRESSO, NM_EVENTO, DS_HORARIO, DS_LOGRADOURO, DS_LOCALIDADE, DS_UF, DS_EVENTO, IMAGEM_INGRESSO, DT_CADASTRO, BT_DESTAQUE
...
export async function BuscarNomeIngresso(nome){
    ...
    const comando = 
        `
        SELECT  CATEGORIA.ID_CATEGORIA_INGRESSO,
            ...
            GROUP BY
            CATEGORIA.ID_CATEGORIA_INGRESSO, LOCAL.ID_LOCAL_EVENTO,INGRESSO.ID_INGRESSO, DATAS.ID_DATA_INGRESSO,  HORARIOS.ID_HORARIO_INGRESSO, NM_CATEGORIA_INGRESSO, NM_TIPO_INGRESSO, QTD_TIPO_INGRESSO, VL_PRECO_TIPO, NM_EVENTO, DS_HORARIO, DS_LOGRADOURO, DS_LOCALIDADE, DS_UF, DS_NUM, DS_EVENTO, IMAGEM_INGRESSO, DT_CADASTRO, BT_DESTAQUE
